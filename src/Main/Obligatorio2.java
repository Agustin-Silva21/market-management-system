...
public class Obligatorio2 {
    ...
    public static void main(String[] args) {
      ...
      Producto p1 = new Producto("Manzana", "rica", Producto.Tipo.Fruta, Producto.FormaVenta.Kilogramo);
      Producto p2 = new Producto("Pera", "rica", Producto.Tipo.Fruta, Producto.FormaVenta.Unidad);
      Producto p3 = new Producto("Naranja", "rica", Producto.Tipo.Verdura, Producto.FormaVenta.Kilogramo);
      Producto p4 = new Producto("Sandia", "rica", Producto.Tipo.Fruta, Producto.FormaVenta.Unidad);
      Producto p5 = new Producto("Lechuga", "rica", Producto.Tipo.Verdura, Producto.FormaVenta.Unidad);
